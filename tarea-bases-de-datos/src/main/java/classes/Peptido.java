...
public class Peptido {
    ...
    public String organismo_fuente=null;
    
    public Peptido(String id, String secuencia, String nombre_principal, int longitud, double peso_molecular, int carga_neta,
                   double hidrofobicidad, boolean es_natural, String estado_verificacion, String organismo_fuente){
        this.id=id;
    ...
    public Peptido(String secuencia, String nombre_principal, double peso_molecular, int carga_neta,
                   double hidrofobicidad, boolean es_natural, String estado_verificacion, String organismo_fuente){
        this.secuencia=secuencia;
        this.nombre_principal = nombre_principal;
        this.peso_molecular=peso_molecular;
